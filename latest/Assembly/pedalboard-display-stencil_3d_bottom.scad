// Generated by SolidPython <Unknown> on 2026-04-22 22:07:00
$fa = 0.4; $fs = 0.4;
...
rotate(a = 0, v = [1, 0, 0]) {
	difference() {
			...
			difference() {
				linear_extrude(height = 1.4500000000) {
					offset(r = 1.0000000000) {
						import(file = "pedalboard-display-stencil_3d_edge.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 0.6000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "pedalboard-display-stencil_3d_bottom.dxf", origin = [0, 0]);
			}
		}
	}
}
